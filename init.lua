...
local options = {
  ...
  -- backup = false,
  -- incsearch = true,
  -- smarttab = true,                       -- Converts tabs to spaces
  -- spell = true,
}
...
require('lazy').setup(
  {
    ...
    -- NOTE: Plugins can also be added by using a table, {{{2
    ...
    -- }}}2
    -- NOTE: Plugins can also be configured to run Lua code when they are loaded. {{{2
    --
    ...
    -- }}}2
    -- NOTE: Plugins can specify dependencies. {{{2
    --
    ...
    { -- Fuzzy Finder (files, lsp, etc)
      ...
      config = function()
        ...
        vim.keymap.set('n', '<leader>gC', builtin.git_bcommits, { desc = 'Search [G]it [C]ommits for current [F]ile' })
